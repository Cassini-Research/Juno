...
usage() {
  ...
  echo "  --cleanse          Reset Juno TCC grants/decisions (Microphone, Accessibility,"
  echo "                     SpeechRecognition, Automation, Reminders, Calendar) so the"
  echo "                     next launch re-prompts. Implies a fresh-install simulation."
  echo "                     Requires --install-to-apps because cleanse targets the"
